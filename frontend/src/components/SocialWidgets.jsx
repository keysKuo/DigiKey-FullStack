...
export default function SocialWidgets() {
  return (
    <div
      className="fixed-contact flex flex-col items-center justify-center z-[1000]
        bg-[#864AF9] fixed z-100 right-0 top-[50%] translate-y-[-50%]
        transition-all duration-300 rounded-l-[30px] px-[0.67rem] py-8 gap-1"
    >
      <a
        className="phone-ring w-[36px] h-[36px] leading-[36px] rounded-[30px]
          bg-[#864AF9] relative my-1 flex items-center justify-center text-[#fff]
          hover:text-[#71B190]"
        href="#"
        target="_blank"
      >
